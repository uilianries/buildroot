...
# infrastructure
#
# In terms of implementation, this Conan infrastructure requires
...
# build the package, instead of the default Conan behaviour. The
...
$(2)_CONAN_OPTS += -o *:shared=$$(CONAN_OPTION_SHARED)

ifeq ($(BR2_GCC_VERSION_10_X),y)
CONAN_SETTING_COMPILER_VERSION = 10
else ifeq ($(BR2_GCC_VERSION_9_X),y)
CONAN_SETTING_COMPILER_VERSION = 9
else ifeq ($(BR2_GCC_VERSION_8_X),y)
...
define $(2)_BUILD_CMDS
	$$(TARGET_MAKE_ENV) $$(CONAN_ENV) $$($$(PKG)_CONAN_ENV) \
		...
		$$(CONAN) create $$(CONAN_OPTS) $$($$(PKG)_CONAN_OPTS) \
		$$($$(PKG)_PKGDIR) $$($$(PKG)_REFERENCE) \
